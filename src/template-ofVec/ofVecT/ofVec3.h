...
namespace of {
	...
	public:
		...
		//
		bool operator==( const ofVec3<T>& vec ) const;
		bool operator!=( const ofVec3<T>& vec ) const;
		...
		// Operator overloading for ofVec3<T>
		//
		ofVec3<T>  operator+( const ofVec3<T>& pnt ) const;
		ofVec3<T>& operator+=( const ofVec3<T>& pnt );
		ofVec3<T>  operator-( const ofVec3<T>& vec ) const;
		ofVec3<T>& operator-=( const ofVec3<T>& vec );
		ofVec3<T>  operator*( const ofVec3<T>& vec ) const;
		ofVec3<T>& operator*=( const ofVec3<T>& vec );
		ofVec3<T>  operator/( const ofVec3<T>& vec ) const;
		ofVec3<T>& operator/=( const ofVec3<T>& vec );
		...
		ofVec3<T>  operator+( const T f ) const;
		ofVec3<T>& operator+=( const T f );
		ofVec3<T>  operator-( const T f ) const;
		ofVec3<T>& operator-=( const T f );
		ofVec3<T>  operator*( const T f ) const;
		ofVec3<T>& operator*=( const T f );
		...
		friend ostream& operator<<(ostream& os, const ofVec3<T>& vec);
		friend istream& operator>>(istream& is, const ofVec3<T>& vec);
		...
		OF_DEPRECATED_MSG("Use ofVec3<T>::lengthSquared() instead.", T squareLength() const);
		/**
	...
	//
	template <typename T>
	ofVec3<T> operator+( T f, const ofVec3<T>& vec );
	template <typename T>
	ofVec3<T> operator-( T f, const ofVec3<T>& vec );
	template <typename T>
	ofVec3<T> operator*( T f, const ofVec3<T>& vec );
	...
	template <typename T>
	template <typename S>
	inline ofVec3<T>::ofVec3( const ofVec2<S>& vec ):x(vec.x), y(vec.y), z(0) {}
	//template <typename T>
	//template <typename S>
	//inline ofVec3<T>::ofVec3( const ofVec4<S>& vec ):x(vec.x), y(vec.y), z(vec.z) {}
	template <typename T>
	inline ofVec3<T>::ofVec3(): x(0), y(0), z(0) {};
	template <typename T>
	inline ofVec3<T>::ofVec3( T _all ): x(_all), y(_all), z(_all) {};
	template <typename T>
	inline ofVec3<T>::ofVec3( T _x, T _y, T _z ):x(_x), y(_y), z(_z) {}
	...
	//
	template <typename T>
	inline bool ofVec3<T>::operator==( const ofVec3<T>& vec ) const {
	...
	template <typename T>
	inline ostream& operator<<(ostream& os, const ofVec3<T>& vec) {
		os << vec.x << ", " << vec.y << ", " << vec.z;
		return os;
	}
	
	template <typename T>
	inline istream& operator>>(istream& is, ofVec3<T>& vec) {
		is >> vec.x;
		is.ignore(2);
		is >> vec.y;
		is.ignore(2);
	...
	template <typename T>
	inline ofVec3<T> ofVec3<T>::operator+( const ofVec3<T>& pnt ) const {
		return ofVec3<T>( x+pnt.x, y+pnt.y, z+pnt.z );
	}
	
	template <typename T>
	inline ofVec3<T>& ofVec3<T>::operator+=( const ofVec3<T>& pnt ) {
		x+=pnt.x;
		y+=pnt.y;
		z+=pnt.z;
		return *this;
	...
	template <typename T>
	inline ofVec3<T> ofVec3<T>::operator-( const ofVec3<T>& vec ) const {
		return ofVec3<T>( x-vec.x, y-vec.y, z-vec.z );
	}
	
	template <typename T>
	inline ofVec3<T>& ofVec3<T>::operator-=( const ofVec3<T>& vec ) {
		x -= vec.x;
		y -= vec.y;
		z -= vec.z;
		return *this;
	...
	//
	//
	//inline void ofVec3<T>::operator=( const T f){
	//	x = f;
	//	y = f;
	//	z = f;
	//}
	...
	template <typename T>
	inline ofVec3<T> ofVec3<T>::operator+( const T f ) const {
		return ofVec3<T>( x+f, y+f, z+f);
	}
	
	template <typename T>
	inline ofVec3<T>& ofVec3<T>::operator+=( const T f ) {
		x += f;
		y += f;
		z += f;
		return *this;
	...
	//
	template <typename T>
	inline ofVec3<T> operator+( T f, const ofVec3<T>& vec ) {
		return ofVec3<T>( f+vec.x, f+vec.y, f+vec.z );
	}
